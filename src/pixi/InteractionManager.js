...
proto.setTarget = function setTarget(target)
{
    ...
    if (this.target) {
        this.target.view.removeEventListener('mousedown', this, true);
        this.target.view.removeEventListener('mousemove', this, true);
        this.target.view.removeEventListener('mouseup', this, true);
        this.target.view.removeEventListener('mouseout', this, true);
        this.target.view.removeEventListener('touchstart', this, true);
        this.target.view.removeEventListener('touchmove', this, true);
        this.target.view.removeEventListener('touchend', this, true);
    }

    target.view.addEventListener('mousedown', this, true);
    target.view.addEventListener('mousemove', this, true);
    target.view.addEventListener('mouseup', this, true);
    target.view.addEventListener('mouseout', this, true);
    // aint no multi touch just yet!
    target.view.addEventListener('touchstart', this, true);
    target.view.addEventListener('touchmove', this, true);
    target.view.addEventListener('touchend', this, true);
